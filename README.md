...
|`output`| Contains an image and a text file for each run. The image is a graph of the training loss, and the text file contains the training epochs and the accuracy on the validation set|
